  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-xl relative">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-purple-500/5 -z-10" />
        <div className="p-8">
          <div className="flex flex-col items-center justify-center mb-8">
            ...
            <p className="text-slate-400 mt-2 text-sm text-center">Login to your AI-powered interview portal</p>
          </div>
